...
$atts['description'] 	= '';
$atts['id'] 			= 'video-url';
$atts['label'] 			= esc_html__( 'Video URL', 'lazy-load-videos' );
$atts['name'] 			= 'video-url';
$atts['placeholder'] 	= '';
$atts['type'] 			= 'url';
$atts['value'] 			= '';
...
$atts['label'] 			= esc_html__( 'Click Behavior', 'lazy-load-videos' );
...
$atts['label'] 			= esc_html__( 'Video Height', 'lazy-load-videos' );
...
$atts['id'] 			= 'video-width';
$atts['label'] 			= esc_html__( 'Video Width', 'lazy-load-videos' );
